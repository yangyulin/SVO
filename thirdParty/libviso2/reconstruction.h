...
namespace libviso2 {
    ...
    public:
        ...
        void
        update(std::vector<Matcher::p_match> p_matched, Matrix Tr, int32_t point_type = 1, int32_t min_track_length = 2,
    ...
    private:
        ...
        bool computePredictionsAndJacobian(const std::vector<Matrix>::iterator &P_begin,
