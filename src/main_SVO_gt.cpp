...
int main (int argc, char** argv) {
    ...
    ///Done TODO: also consider to read in the ground truth
    for (int32_t i=0; i<4500; i++) {
        ...
        try {
            ...
            if (viso->process(left_img_data,right_img_data,dims)) {
                ...
                SVO::localOptimization(pM, inliers, poseInit, param, sigmaPixel, K, model, poseOpt);
    ...
    // output
    cout << "main_SVO_gt complete! Exiting ..." << endl;
